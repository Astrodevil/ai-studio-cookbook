...
[View all available NVIDIA Nemotron Models](nemotron/README.md)

| Model | Provider | Parameters | Context | Highlights |
|-------|----------|------------|---------|------------|
| [Kimi-K3](kimi-k3.md)<br><br>[▶ Try it](https://tokenfactory.nebius.com/playground?models=moonshotai/Kimi-K3) | Moonshot AI | 2.8 T | 1 M | Latest open model from Moonshot AI — strong reasoning and agentic capability |
| [Kimi K2.7 Code](kimi-k2.7-code.md)<br><br>[▶ Try it](https://tokenfactory.nebius.com/playground?models=moonshotai/Kimi-K2.7-Code) | Moonshot AI | 1T total · 32B active | 256K | Coding-focused agentic MoE — native multimodal with MoonViT; ~30% thinking-token reduction vs K2.6 |
| [MiniMax M3](minimax-m3.md)<br><br>[▶ Try it](https://tokenfactory.nebius.com/playground?models=MiniMaxAI/MiniMax-M3) | MiniMax | 428B total · 23B active | 1 M | Native multimodal MoE (text+image+video) with MiniMax Sparse Attention — frontier coding and cowork |
